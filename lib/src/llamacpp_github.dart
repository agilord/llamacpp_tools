...
/// Utility class for methods using or accessing the llama.cpp GitHub page.
class LlamacppGithub {
  ...
  static Future<List<String>> scrapeRecentVersions() async {
    ...
    try {
      ...
      if (response.statusCode != 200) {
        throw Exception(
          'Failed to fetch releases page: ${response.statusCode}',
        );
      }
  ...
  static Future<LlamacppDir> downloadAndSetupRelease({
