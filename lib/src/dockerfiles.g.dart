...
// Generated from Dockerfiles in docker/

/// Content of cuda-builder.Dockerfile
const String _cudaBuilderDockerfile =
    r'''# Dockerfile for building llama.cpp with CUDA and multimodal support
...
/// Map from relative filename to Dockerfile content
final Map<String, String> dockerfileContents = {
